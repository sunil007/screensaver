<?php
	...
	if(
		...
		$userObject = SalesMan::getSalesManById($userId);
		if(!$userObject || $userObject->status != 0){
			echo Response::getFailureResponse(null, 416);
			exit(0);
		}
		
		SalesMan::updateSalesManDetails($userObject->id, $userName, $email, $userAddressLine1, $userAddressLine2, $userCity, $userState, $userPincode, $userAadhar, 0);
